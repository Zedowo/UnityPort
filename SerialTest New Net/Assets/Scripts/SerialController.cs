...
public class SerialController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Vec.y += Input.GetAxis("Jump") * Time.deltaTime * movementint;
        //Vec.x += Input.GetAxis("Horizontal") * Time.deltaTime * movementint;
        //Vec.z += Input.GetAxis("Vertical") * Time.deltaTime * movementint;
